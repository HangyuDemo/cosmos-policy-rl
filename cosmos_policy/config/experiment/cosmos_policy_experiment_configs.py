    ...
    dict(
        ...
        model=L(CosmosPolicyVideo2WorldModel)(
            config=dict(
                ...
                state_t=10,  # Latent temporal dim (blank, proprio, wrist, primary, action, trajectory, future primary, future wrist, future proprio, value)
                ...
                tokenizer=dict(
                    chunk_duration=37,  # 1 blank + 36 images (4 proprio, 4 wrist, 4 primary, 4 action, 4 trajectory, 4 future primary, 4 future wrist, 4 future proprio, 4 value)
                ),
                ema=dict(
                    enabled=False,
                ),
